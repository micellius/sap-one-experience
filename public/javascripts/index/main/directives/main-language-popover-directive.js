 ...
 */
angular.module('sapMain').directive('sapMainLanguagePopoverDirective', [
            ...
            template:
                '<div class="popover bottom sap-language-popover">' +
                    ...
                    '<div class="popover-content">' +
                        '<ul class="list-group">' +
                            '<li class="list-group-item" ng-repeat="locale in locales" ng-click="setLocale(locale)">{{locale | uppercase}}</li>' +
                        '</ul>' +
                    '</div>' +
                '</div>',
            replace: true,
